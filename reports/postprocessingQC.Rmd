...
plantarea_ts =
  ...
  geom_path(aes(y=avg, color=gtype, linetype = treatment),size=1.2)+
...
plantarea_errors <- 
  ...
  geom_errorbar(aes(ymin = avg-sterr, ymax=avg+sterr), width=0.9, position=position_dodge2(), color='grey50')+
